...
OBDReader = function () {
    ...
    console.log ("OBD Instantiation, connected = false");
...
OBDReader.prototype.autoconnectTCP = function (url, instance) {
    ...
    OBDSocket.open(hp[0], parseInt(hp[1]),
        ...
        function (err) {
            ...
            console.log ("OBDSocket open error. setting connection false");
    ...
    OBDSocket.onClose = function (data) {
        ...
        console.log ("OBDSocket onClose called. setting connection false");
        self.connected = false;
    ...
    OBDSocket.onError = function (data) {
        ...
        console.log ("OBDSocket onError called. setting connection false");
...
OBDReader.prototype.removeAllPollers = function () {
    activePollers = []; // added - not sure why not? 
